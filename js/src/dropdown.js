    ...
    _createClass(Dropdown, [{
      ...
      value: function _handleDropdownKeydown(e) {
        ...
        if (letter && nonLetters.indexOf(e.which) === -1) {
          (function () {
            _this3.filterQuery.push(letter);

            var string = _this3.filterQuery.join(''),
                newOptionEl = $(_this3.dropdownEl).find('li').filter(function (el) {
              return $(el).text().toLowerCase().indexOf(string) === 0;
            })[0];

            if (newOptionEl) {
              _this3.focusedIndex = $(newOptionEl).index();
              _this3._focusFocusedItem();
            }
          })();
        }
      ...
      value: function _animateIn() {
        ...
        anim({
          ...
          complete: function complete(anim) {
            if (_this4.options.autoFocus) {
              _this4.dropdownEl.focus();
            }
