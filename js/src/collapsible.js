        ...
        if ($collapsibleLi.length) {
          (function () {
            ...
            anim({
              ...
              duration: _this4.options.inDuration,
        ...
        if ($collapsibleLi.length) {
          (function () {
            ...
            anim({
              ...
              paddingTop: 0,
              paddingBottom: 0,
              duration: _this5.options.outDuration,
              easing: 'easeInOutCubic',
      ...
      value: function open(index) {
        ...
        if ($collapsibleLi.length && !$collapsibleLi[0].classList.contains('active')) {
          ...
          if (this.options.accordion) {
            (function () {
              var $collapsibleLis = _this6.$el.children('li');
              var $activeLis = _this6.$el.children('li.active');
